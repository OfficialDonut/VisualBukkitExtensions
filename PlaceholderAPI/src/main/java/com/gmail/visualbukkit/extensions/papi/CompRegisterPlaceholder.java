...
public class CompRegisterPlaceholder extends PluginComponent {
    ...
    public CompRegisterPlaceholder() {
        super("comp-register-placeholder", "Register Placeholder", "PAPI", "Registers a placeholder (%pluginName_identifier%)");
    }

    @Override
    public Block createBlock() {
        return new Block(this, new StringLiteralParameter("Identifier")) {
            @Override
